...
export function OverviewAppView() {
  ...
  const widgetData = {
    ...
    algebraRewardApdData: [
      {
        title: '今日代数奖励APD',
        total: apiData?.admin_algebra_reward_apd_res?.today_profit || '0',
        unit: 'APD',
        color: 'primary',
      },
      {
        title: '本周代数奖励APD',
        total: apiData?.admin_algebra_reward_apd_res?.week_profit || '0',
        unit: 'APD',
        color: 'secondary',
      },
      {
        title: '本月代数奖励APD',
        total: apiData?.admin_algebra_reward_apd_res?.month_profit || '0',
        unit: 'APD',
        color: 'success',
      },
    ],
  ...
  const categoryNameMap: Record<string, string> = {
    algebraRewardApdData: '代数奖励APD数据',
