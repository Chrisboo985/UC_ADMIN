          ...
          >
            ...
            <Tooltip title={address} arrow>
              ...
              >
                {address}
                <br />
                <span style={{ color: 'gray' }}>用户备注:{remark}</span>
              </Typography>
            </Tooltip>
            ...
            <Box sx={{ width: '100%' }}>
              ...
              <Grid item xs={6}>
                  <Item style={{ fontSize: 13 }}>
                    <Tooltip title={`债券KSN:${Number(bond_ksp_amount).toFixed(2)}`} arrow>
                      <Typography
                        variant="caption"
                        component="span"
                        noWrap
                        ...
                        onClick={() => {
                          copyToClipboard(`${Number(bond_ksp_amount).toFixed(2)}`);
                          toast.success('债券KSN已复制到剪贴板');
                        }}
                      >
                        债券KSN:{' '}
                        <span style={{ color: '#00A76F' }}>{Number(bond_ksp_amount).toFixed(2)}</span>
                      </Typography>
                    </Tooltip>
                  </Item>
                </Grid>
                <Grid item xs={6}>
                  <Item style={{ fontSize: 13 }}>
                    <Tooltip title={`债券usdt:${Number(bond_usdt_amount).toFixed(2)}`} arrow>
                      <Typography
                        variant="caption"
                        component="span"
                        noWrap
                        ...
                        onClick={() => {
                          copyToClipboard(`${Number(bond_usdt_amount).toFixed(2)}`);
                          toast.success('债券usdt已复制到剪贴板');
                        }}
                      >
                        债券USDT:{' '}
                        <span style={{ color: '#00A76F' }}>{Number(bond_usdt_amount).toFixed(2)}</span>
                      </Typography>
                    </Tooltip>
                  </Item>
                </Grid>
                ...
                <Grid item xs={6}>
                  <Item style={{ fontSize: 13 }}>
                    <Tooltip title={`净KSN入金:${Number(net_ksp_deposit).toFixed(2)}`} arrow>
                      <Typography
                        variant="caption"
                        component="span"
                        noWrap
                        ...
                        onClick={() => {
                          copyToClipboard(`${Number(net_ksp_deposit).toFixed(2)}`);
                          toast.success('净KSN入金已复制到剪贴板');
                        }}
                      >
                        净KSN入金:{' '}
                        <span style={{ color: '#00A76F' }}>{Number(net_ksp_deposit).toFixed(2)}</span>
                      </Typography>
                    </Tooltip>
                  </Item>
                </Grid>
                ...
                <Grid item xs={6}>
                  <Item style={{ fontSize: 13 }}>
                    <Tooltip title={`净usdt入金:${Number(net_usdt_deposit).toFixed(2)}`} arrow>
                      <Typography
                        variant="caption"
                        component="span"
                        noWrap
                        ...
                        onClick={() => {
                          copyToClipboard(`${Number(net_usdt_deposit).toFixed(2)}`);
                          toast.success('净usdt入金已复制到剪贴板');
                        }}
                      >
                        净usdt入金:{' '}
                        <span style={{ color: '#00A76F' }}>{Number(net_usdt_deposit).toFixed(2)}</span>
                      </Typography>
                    </Tooltip>
                  </Item>
                </Grid>
