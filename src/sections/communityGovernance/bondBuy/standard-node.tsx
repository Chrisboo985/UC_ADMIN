              ...
              <Grid container spacing={0}>
                <Grid item xs={6}>
                  <Item style={{ fontSize: 13 }}>
                    ...
                    <Tooltip title={`KSN债券购买数量:${Number(bond_ksp_amount).toFixed(2)}`} arrow>
                      <Typography
                        variant="caption"
                        component="span"
                        noWrap
                        ...
                        onClick={() => {
                          ...
                          toast.success('KSN债券购买数量已复制到剪贴板');
                        }}
                      >
                        KSN债券购买数量:{' '}
                ...
                <Grid item xs={6}>
                  <Item style={{ fontSize: 13 }}>
                    <Tooltip title={`usdt债券出金:${Number(bond_usdt_amount).toFixed(2)}`} arrow>
                      <Typography
                        variant="caption"
                        component="span"
                        noWrap
                        ...
                        onClick={() => {
                          ...
                          toast.success('usdt债券购买数量已复制到剪贴板');
                        }}
                      >
                        usdt债券购买数量:{' '}
