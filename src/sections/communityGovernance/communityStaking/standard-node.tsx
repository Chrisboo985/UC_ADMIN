...
export const StandardNode = function StandardNode({
  ...
  console.log("member_id",member_id,children);
          ...
          <Box sx={{ width: '100%' }}>
            <Grid container spacing={0}>
              ...
              <Grid item xs={6}>
                <Item style={{ fontSize: 13 }}>
                  <Tooltip
                    title={`社区团队无衰减质押量:${Number(full_team_all_stake).toFixed(2)}`}
                    arrow
                  >
                    <Typography
                      variant="caption"
                      ...
                      onClick={() => {
                        copyToClipboard(`${Number(full_team_all_stake).toFixed(2)}`);
                        toast.success('社区团队无衰减质押量已复制到剪贴板');
                      }}
                    >
                      团队无衰减质押量:{' '}
                      <span style={{ color: '#00A76F' }}>
                        {Number(full_team_all_stake).toFixed(2)}
                      </span>
                    </Typography>
                  </Tooltip>
                </Item>
