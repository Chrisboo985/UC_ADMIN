...
export function UserListView() {
  ...
  const getList = useCallback(async () => {
    ...
    await getMemberPerformanceSwap(params)
      .then((apiResult) => {
  ...
  const columns: GridColDef[] = [
    {
      ...
      renderCell: (params) => {
        ...
        const timestamp = params.row.tx_at;
    ...
    },
    {
      ...
      // 展示前后五位
      renderCell: (params) => (
        <CellWithTooltipCopy value={params.row.tx_hash} props={{ displayLength: 16 }} />
      ),
    },
    {
      field: 'trans_type',
      ...
      // 展示前后五位
      renderCell: (params) => (
        <CellWithTooltipCopy value={params.row.trans_type === 'send' ? '出金' : '入金'} props={{ displayLength: 16 }} />
      ),
    },
    {
      field: 'member_code',
    ...
    {
      field: 'usdt_token_amount',
      headerName: 'usdt数量',
      minWidth: 210,
      flex: 1,
      // 展示前后五位
      renderCell: (params) => (
        <CellWithTooltipCopy value={params.row.usdt_token_amount} props={{ displayLength: 16 }} />
      ),
    },
    {
      field: 'ksp_token_amount',
      headerName: 'KSN数量',
      minWidth: 210,
      flex: 1,
      // 展示前后五位
      renderCell: (params) => (
        <CellWithTooltipCopy value={params.row.ksp_token_amount} props={{ displayLength: 16 }} />
      ),
    },
